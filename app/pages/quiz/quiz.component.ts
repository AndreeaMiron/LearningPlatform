...
export class QuizComponent implements OnInit {
  ...
  ngOnInit(): void {
    //initializam lista de quiz-uri cu cele din service
    this.quizzes = this.quizService.getQuizzes();
    //luam random o intrebare
    this.currentQuiz = this.getRandom();
    //punem intrebarea in lista cu intrebari deja raspunse
